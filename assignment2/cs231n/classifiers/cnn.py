...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        conv_stride = 1
        pad = (filter_size - 1) // 2
        H_conv = (H + 2 * pad - filter_size) // conv_stride + 1
        W_conv = (W + 2 * pad - filter_size) // conv_stride + 1
        ...
        pre_hidden_dim = num_filters * H_pool * W_pool

        self.params['W1'] = weight_scale * np.random.randn(num_filters, C, filter_size, filter_size)
        self.params['b1'] = np.zeros(num_filters)
        self.params['W2'] = weight_scale * np.random.randn(pre_hidden_dim, hidden_dim)
